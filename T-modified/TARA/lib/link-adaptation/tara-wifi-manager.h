 ...
 * A vector of a struct TARARateInfo.
 */
typedef std::vector<TARARateInfo> TARARate;
...
struct GroupInfo
{
    ...
    TARARate m_ratesTable; //!< Information about rates of this group.
};
 ...
 */
class TARAWifiManager : public WifiRemoteStationManager
{
  public:
    /**
  ...
  private:
     ...
     */
    void UpdateRetry(TARAWifiRemoteStation* station);
     ...
     */
    void UpdatePacketCounters(TARAWifiRemoteStation* station,
                              uint16_t nSuccessfulMpdus,
                              uint16_t nFailedMpdus);
     ...
     */
    uint16_t GetNextSample(TARAWifiRemoteStation* station);
     ...
     * \param station the wifi remote station
     */
    void SetNextSample(TARAWifiRemoteStation* station);
     ...
     */
    uint16_t FindRate(TARAWifiRemoteStation* station);
     ...
     * \param station the Minstrel-HT wifi remote station
     */
    void UpdateStats(TARAWifiRemoteStation* station);
     ...
     * \param station the Minstrel-HT wifi remote station
     */
    void RateInit(TARAWifiRemoteStation* station);
     ...
     */
    double CalculateThroughput(TARAWifiRemoteStation* station,
                               uint8_t groupId,
                               uint8_t rateId,
                               double ewmaProb);
     ...
     */
    void SetBestStationThRates(TARAWifiRemoteStation* station, uint16_t index);
     ...
     * \param index the index
     */
    void SetBestProbabilityRate(TARAWifiRemoteStation* station, uint16_t index);
     ...
     * \param index the index
     */
    void CalculateRetransmits(TARAWifiRemoteStation* station, uint16_t index);
     ...
     * \param rateId the rate ID
     */
    void CalculateRetransmits(TARAWifiRemoteStation* station,
                              uint8_t groupId,
                              uint8_t rateId);
     ...
     * \param station the Minstrel-HT wifi remote station
     */
    void InitSampleTable(TARAWifiRemoteStation* station);
     ...
     * \param station the Minstrel-HT wifi remote station
     */
    void PrintSampleTable(TARAWifiRemoteStation* station);
     ...
     * \param station the Minstrel-HT wifi remote station
     */
    void PrintTable(TARAWifiRemoteStation* station);
     ...
     */
    void StatsDump(TARAWifiRemoteStation* station, uint8_t groupId, std::ofstream& of);
     ...
     * \param station the Minstrel-HT wifi remote station
     */
    void CheckInit(TARAWifiRemoteStation* station);
     ...
     */
    uint32_t CountRetries(TARAWifiRemoteStation* station);
     ...
     * \param station the Minstrel-HT wifi remote station
     */
    void UpdateRate(TARAWifiRemoteStation* station);
     ...
     */
    uint16_t GetLowestIndex(TARAWifiRemoteStation* station);
     ...
     * \returns the lowest global index
     */
    uint16_t GetLowestIndex(TARAWifiRemoteStation* station, uint8_t groupId);
    ...
    uint16_t m_TARARate;           //!< The TARA Algorithm current MCS prediction (MCS id)
    double m_TARASnr;           //!< The TARA Algorithm current SNR prediction (dB)

...
main (int argc, char **argv)
{
  ...
  Simulator::Run ();
  Simulator::Destroy ();
    std::ofstream summary("packet_summary.txt");

    summary << "FAP → FGW:\n";
    summary << "  TX: " << txPacketsFAPtoFGW << "\n";
    summary << "  RX: " << rxPacketsFGWfromFAP << "\n\n";

    summary << "FGW → BKH:\n";
    summary << "  TX: " << txPacketsFGWtoBKH << "\n";
    summary << "  RX: " << rxPacketsBKHfromFGW << "\n\n";

    summary << "Interference Node:\n";
    summary << "  TX: " << txPacketsInterferer << "\n";

    summary <<"Total Received" << totaltxPackets << "\n";
    summary << "Actual SNR at BKH: " << currentSnrBkh << "\n";
